...
create table users (id int8 generated by default as identity, cellphone_number varchar(255) not null, email varchar(255) not null, home_number varchar(255), first_name varchar(255) not null, last_name varchar(255) not null, license_plate varchar(255) not null, registration_date date, fk_address_id int8 not null, primary key (id));
